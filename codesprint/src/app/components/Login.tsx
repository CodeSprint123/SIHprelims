  ...
  return (
    ...
    <div className="bg-cover bg-center bg-fixed min-h-screen text-white" style={{ backgroundImage: 'url("background.webp")' }}>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-96 rounded-2xl">
        <h1 className="text-center text-3xl font-semibold border-b-2 border-silver py-4">Log in</h1>
        <form className="px-10 py-4">
          ...
          <input type="submit" value="Login" className="w-full bg-0f222e text-white py-2 rounded-2xl hover:border-aquamarine cursor-pointer" />
        </form>
        <div className="text-center mt-4">
          <p>Don't have an account? <a href="signup.html" className="text-blue-500">Sign up</a></p>
        </div>
      </div>
    </div>
    </>
